...
<Tabs>
  <TabItem value="CentOS/RHEL" label="CentOS/RHEL" default>
    ...
    * The `jq` CLI is installed and systemd is configured as the service manager.
    ...
    1. Install seekdb by following the verified download and installation procedure in [Deploy seekdb with package managers](../../400.guides/400.deploy/700.server-mode/100.deploy-by-systemd.md). Do not pipe a remote script directly to a privileged shell.
  ...
  <TabItem value="Debian/Ubuntu" label="Debian/Ubuntu">
    ...
    * The `jq` CLI is installed and systemd is configured as the service manager.
    ...
    1. Install seekdb by following the signed or checksum-verified package procedure in [Deploy seekdb with package managers](../../400.guides/400.deploy/700.server-mode/100.deploy-by-systemd.md). Do not disable APT repository signature verification.
