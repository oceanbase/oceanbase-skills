...
- [Source-evidence boundary](../../references/source-baselines.md#source-evidence-boundary): `const.py`, `_cmd.py`, `core.py`, `plugins/oms/1.0.0/`, `workflows/oms/1.0.0/`, and the OBD Web OMS handler in the exact inspected checkout.
