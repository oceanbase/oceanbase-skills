...
- [Source-evidence boundary](../../references/source-baselines.md#source-evidence-boundary): `_cmd.py` `BinlogCommand` family; `core.py` Binlog instance methods; `plugins/obbinlog-ce/4.0.1/` in the exact inspected checkout.
